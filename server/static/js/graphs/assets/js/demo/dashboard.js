/*
 * MoonCake v1.1 - Dashboard Demo JS
 *
...
;(function( $, window, document, undefined ) {
	...
	var demos = {
		//draws the chart with math plots
		trigometryCharts: function( key, selector ) {
			...
			function plotNow() {					
				var data = [];
				var sin = [], cos = [];
				var colors = ['#115b74', '#e49600', '#cc2b36', '#e18876']; //j: colors for 2nd chart
...
///////////////// Real-time chart  /////////////////////////
		...
		updatingChart: function( key, selector ) {
			...
			var stockValue = [], 
				...
				yaxis: { min: 0, max: 100 },
				//xaxis: { min: 0, max: 100 },				
				//j: adding live time functionality
				xaxis: {
					mode: "time",
					tickSize: [2, "second"],
				...
				//j: END OF adding live time functionality
			...
			_d = [
				...
				//{ data: getRandomData(), label: 'Energy generated', color: 'green', points: { show: false } }  //j: we have only 1 chart currently: Pout
			], 
			liveUpdate = true, 
			timeout = null;
