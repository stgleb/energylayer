...
social_profile = Table('social_profile', post_meta,
    ...
    Column('provider_name', String(length=64)),
    Column('nickname', Unicode(length=64)),
...
def upgrade(migrate_engine):
    ...
    post_meta.tables['social_profile'].columns['provider_name'].create()
...
def downgrade(migrate_engine):
    ...
    pre_meta.bind = migrate_engine
    post_meta.bind = migrate_engine
    post_meta.tables['social_profile'].columns['provider_name'].drop()
